...
═══════════════════════════════════════════════════════════════════════════
  ...
  This describes the PROJECT, not the harness. When rendering:
    ...
    2. Keep the STATUS:START / STATUS:END marker lines verbatim — /handoff
       regenerates the content between them from docs/PHASE_STATUS.md. Never
...
<!-- STATUS:START (generated by /handoff — do not hand-edit between these markers) -->
...
[For a control-plane / code split, say which repo is the product and which is this
control plane.]
