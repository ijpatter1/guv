...
gcp-setup:
	@echo ""
	@echo "═══════════════════════════════════════════════════════════════"
	@echo "  GCP Service Account Setup for the Claude Code agent"
	@echo "═══════════════════════════════════════════════════════════════"
	@echo ""
	@echo "  1. Create a service account:"
	@echo "     gcloud iam service-accounts create claude-agent \\"
	@echo "       --display-name='Claude Code agent' \\"
	@echo "       --project=YOUR_PROJECT_ID"
	@echo ""
	@echo "  2. Grant required roles (adjust for your project's needs):"
	@echo "     PROJECT=YOUR_PROJECT_ID"
	@echo "     SA=claude-agent@\$$PROJECT.iam.gserviceaccount.com"
	@echo ""
