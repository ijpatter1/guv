...
`/guv:replan` (read `.claude/commands/replan.md` and follow its procedure — classify,
...
One `/guv:replan` operation per finding, each with its own confirmation. Commit the
