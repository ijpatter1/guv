...
## 10 — Fail loud
"Completed" is false if anything was skipped silently. "Tests pass" is false if any were skipped or stubbed. If you cut a corner, hit a wall, or made a tradeoff you're unsure about, surface it — in the response and in the session handoff. Hidden uncertainty is the most expensive kind. (The stop-check hook and the review gate are the deterministic backstop; this rule is your half of it.)
